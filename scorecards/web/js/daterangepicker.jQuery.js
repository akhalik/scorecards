...
function getFirstRoundStartDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d1 = new Date(yy,2,1);
    return  format(d1,flag);
} 
function getFirstRoundEndDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d2 = new Date(yy,4,30);
    return  format(d2,flag);
} 


function getSecondRoundStartDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d1 = new Date(yy,6,1);
    return format(d1,flag);
} 
function getSecondRoundEndDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d2 = new Date(yy,9,30);
    return format(d2,flag);
} 
function getThirdRoundStartDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d1 = new Date(yy,10,1);
    return format(d1,flag);
} 
function getThirdRoundEndDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d2 = new Date(yy,11,30);
    return format(d2,flag);
} 
function getFourthQuarterStartDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d1 = new Date(yy,9,1);
    return format(d1,flag);
} 
function getFourthQuarterEndDate(flag){
    var d = new Date();
    var yy = d.getFullYear();
    var d2 = new Date(yy,11,31);
    return format(d2,flag);
}
...
(function ($) {
    ...
    $.fn.daterangepicker = function(settings){
        ...
        var options = $.extend({
            ...
            {
                text: 'First Round', 
                dateStart: getFirstRoundStartDate('S'),
                dateEnd: getFirstRoundEndDate('S')
            },
            {
                text: 'Second Round', 
                dateStart: getSecondRoundStartDate('S'),
                dateEnd: getSecondRoundEndDate('S')
            },
            {
                text: 'Third Round', 
                dateStart: getThirdRoundStartDate('S'),
                dateEnd: getThirdRoundEndDate('S')
            },
            //{
            //    text: 'Fourth Quarter', 
            //    dateStart: getFourthQuarterStartDate('S'),
            //    dateEnd: getFourthQuarterEndDate('S')
            //},
        ...
        //build picker and
        var rp = $('<div class="ui-daterangepicker ui-widget ui-helper-clearfix ui-widget-content ui-corner-all" style="z-index:3000"></div>');
...
function format(date,flag){
    if(!date.getDate()){
        return '';
    }
    var year = date.getFullYear();
    var day,month;             
    // alert($.datepicker.formatDate( dateFormat, date ))
    if(flag == 'S'){
